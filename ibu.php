...
<div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="prosesibu.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="tahun_lahir_ibu" id="tahun_lahir_ibu" class="form-control <?php echo ($error_tahun_lahir_ibu !="" ? "is-invalid" : ""); ?>" placeholder="" value="<?php echo $tahun_lahir_ibu; ?>"> <span class="warning"><?php echo $error_tahun_lahir_ibu?></span>
                        </div>
                    </div><br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="col-sm-2 form-select" name=" pendidikan_ibu">
                            <option value=""></option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="col-sm-2 form-select" name=" pekerjaan_ibu">
                            <option value=""></option>
                    ...
                    <div class="form-group row">
                        <label for="    penghasilan_bulanan_ibu" class="col-sm-2 col-form-label">Penghasilan Bulanan</label>
                        <div class="col-sm-10">
                            <input type="radio" name="  penghasilan_bulanan_ibu" value="< 500.000"> < 500.000 </label> <br>
                            <input type="radio" name="  penghasilan_bulanan_ibu" value="500.000 - 999.9999"> 500.000 - 999.9999 </label><br>
                            <input type="radio" name="  penghasilan_bulanan_ibu" value="1.000.000 - 1.999.999"> 1.000.000 - 1.999.999 </label><br>
                            <input type="radio" name="  penghasilan_bulanan_ibu" value="2.000.000 - 4.999.999"> 2.000.000 - 4.999.999 </label><br>
                            <input type="radio" name="  penghasilan_bulanan_ibu" value="5.0000.000 - 20.000.000"> 5.0000.000 - 20.000.000 </label> <br>
                            <input type="radio" name="  penghasilan_bulanan_ibu" value="20.000.000"> > 20.000.000 </label>
                            <span class="warning" ><?php echo $error_penghasilan_bulanan_ibu; ?></span>
                        </div>
                    </div><br>

                    <div class="form-group row">
                        <label for="        kebutuhan_khusus_ibu" class="col-sm-2 col-form-label "> Berkebutuhan Khusus </label>
                        <div class="col-sm-10">
                            <select class="col-sm-2 form-select" name=" kebutuhan_khusus_ibu">
                            <option value=""></option>
                            ...
                            <span class="warning" ><?php echo $error_kebutuhan_khusus_ibu; ?></span>
                        </div>
                    </div>
